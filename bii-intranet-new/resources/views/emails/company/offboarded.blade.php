                                        ...
                                        <table border="0" width="100%" cellpadding="0" cellspacing="0" align="center" style="width:100%; max-width:100%;">
                                            ...
                                            <tr>
                                                <td align="center" valign="middle" style="font-family:'Poppins', sans-serif;color:#191919;font-size:22px;line-height:32px;font-weight:700;letter-spacing:0px;padding:0;padding-bottom:10px;">
                                                    You have been offboarded from BII Intranet.
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td align="center" valign="middle" style="font-family:'Poppins', sans-serif;color:#939393;font-size:14px;line-height:24px;font-weight:400;letter-spacing:0px;padding:0;padding-bottom:30px;">
                                                    We’re sending this email to announce that you have been offboarded from the BII Intranet.
                                                    <br/><br/>
                                                    We wanted to take a moment to thank you for being a valued user of our intranet platform, BII Intranet. We appreciate your engagement and the contributions you have made during your time with us.
                                                    <br/><br/>
                                                    If you have any questions or if something went wrong during your experience, please don't hesitate to reach out to the BII admin team. They will be more than happy to assist you.
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
