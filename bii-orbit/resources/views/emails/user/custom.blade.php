@props(['fromEmail', 'fromName', 'emailSubject', 'emailContent'])
@extends('.emails/layouts/app', ['title' => $emailSubject])
                                        ...
                                        <tbody>
                                            <tr>
                                                <td
                                                    ...
                                                    <x-email.paragraph
                                                        paragraph="{{ strip_tags($emailContent) }}"
                                                    />

                                                    <x-email.paragraph
                                                        paragraph="{{ __('mail.custom_user_explanation') . $fromName . ' (' . $fromEmail . ')' }}"
                                                    />
                                                </td>
                                            </tr>
                                        </tbody>
